            ...
            repeat nextch; lgth := lgth + 1;
                  if lgth <= strglgth then begin
                    if ch = '\' then begin
                      ...
                      nextch;
                      if ch = 'a' then string[lgth] := chr(7)
                      else if ch = 'b' then string[lgth] := chr(8)
                      else if ch = 't' then string[lgth] := chr(9)
                      else if ch = '\' then string[lgth] := chr(92)
                      else string[lgth] := ch;
                    end else string[lgth] := ch;
                  end
            until (eol) or (ch = '''');
